...
-   **(Intercept)**: -43
    ...
    -   This is the log-odds of a flower being categorized/classified as a versicolor flower at 0 petal length.

-   **Petal.length predictor**: 9.002

    -   This coefficient represents for each 1 increase in petal length, the log odds of a flower being classified as virginica increases by 9.002 compared to versicolor. This is a significant predictor
...
```{r}
flower <- glm(Species ~ Petal.Length + Petal.Width, 
...
-   **(Intercept)**: -45
    ...
    -   This is the log-odds of a flower being categorized/classified as a Versicolor (0) flower at 0 petal length.

-   **your predictor**:

    -   For every 1 increase in Petal Length, the log-odds chance that the model classifies it as Virginica (1) significantly increases by 5.755 compared to Versicolor (0).
    -   For every 1 increase in Petal Width, the log-odds chance that the model classifies it as Virginica (1) significantly increases by 10.447 compared to Versicolor (0).
