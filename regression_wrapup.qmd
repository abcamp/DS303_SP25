---
title: "Assignment 2: Wrapping up linear regression"
author: 
  - "Student Name"
  - "DS303, SP25"
  - "Prof. Amber Camp"
...
Apply a logistic regression. Remember that your predicted outcome variable needs to be binary (or categorical with two levels). Either choose `sex` as your outcome OR subset some other categorical variable so that there are only two levels. Include as many predictor variables as you'd like.
