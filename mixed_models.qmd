...
2.  For each additional day of sleep deprivation, reaction time increased by 10.4673 ms.

3.  

    ## Bonus: How much variation is explained by the random effect? Hint: (variance of RE) / (total variance)
...
There is repeated variables on the same subject!
...
2.  Bonus: Convert the log odds to an odds ratio. Hint: *e*^coefficient^ = e\^0.58523 = 1.79 \~ 1.8

    -   Interpretation: For each additional day of sleep deprivation, the odds of being impaired increases by about 80%.

3.  Do the same for the Intercept. *e*^-3.19546^ = 0.0409.... \~ 0.04
